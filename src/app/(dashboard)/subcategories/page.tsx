      ...
      <div className="min-h-[400px]">
        {isLoading ? (
          <div className="flex h-64 flex-col items-center justify-center gap-3 rounded-2xl bg-card shadow-sm ring-1 ring-black/[0.04]">
            ...
            <p className="text-[11px] font-bold text-muted-foreground/30">Loading subcategories...</p>
          </div>
        ) : subs.length === 0 ? (
              ...
              <div className="overflow-x-auto min-h-[360px]">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-black/[0.04]">
                    {subs.map((sub) => (
                      <tr key={sub.id || sub._id} className="group transition-colors hover:bg-muted/[0.15]">
            ...
            <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-4">
              {subs.map((sub) => (
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="h-12 w-12 rounded-xl bg-muted overflow-hidden border border-border/30 flex items-center justify-center">
                        {sub.media?.url ? (
                          ...
                          <IconHierarchy size={20} className="text-muted-foreground/20" />
                        )}
                      </div>
                      <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 py-1 border-y border-black/[0.03]">
                    <div className="space-y-1">
                      <span className="text-[9px] font-bold text-muted-foreground/40 uppercase tracking-widest">Custom Fields</span>
                      <div className="flex items-center gap-1.5">
                        <span className="text-xs font-bold text-foreground">{sub.customFieldDefinitions?.length || 0} Defined</span>
                      </div>
                    </div>
                    <div className="space-y-1 text-right">
                      <span className="text-[9px] font-bold text-muted-foreground/40 uppercase tracking-widest">Unique ID</span>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => handleOpenManageFields(sub)}
                      className="flex-1 h-9 rounded-xl bg-[#B5651D]/5 text-[10px] font-bold text-[#B5651D] hover:bg-[#B5651D] hover:text-white transition-all flex items-center justify-center gap-2 border border-[#B5651D]/10"
                    >
                      <IconForms size={14} />
                      Fields
                    </button>
                ...
                {formData.customFieldDefinitions.length === 0 ? (
                  <div className="space-y-4">
                    ...
                    <button
                      type="button"
                      onClick={addField}
                      className="flex h-10 w-full items-center justify-center gap-1.5 rounded-xl border border-dashed border-border hover:border-[#B5651D]/40 bg-card hover:bg-[#B5651D]/5 text-[11px] font-black uppercase tracking-widest text-[#B5651D] transition-all shadow-sm active:scale-95"
                    >
